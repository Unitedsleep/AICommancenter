if ($PSEdition -eq 'Core') {
    ...
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.barcodes.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.commons.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.forms.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.html2pdf.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.hyph.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.io.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.kernel.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.layout.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.pdfa.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.sign.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.styledxmlparser.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\itext.svg.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\Microsoft.DotNet.PlatformAbstractions.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\Microsoft.Extensions.DependencyModel.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\Microsoft.Extensions.Logging.Abstractions.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\Microsoft.Extensions.Logging.dll
    Add-Type -Path $PSScriptRoot\Lib\Core\Microsoft.Extensions.Options.dll
} else {
    Add-Type -Path $PSScriptRoot\Lib\Default\BouncyCastle.Crypto.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.barcodes.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.commons.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.forms.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.html2pdf.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.hyph.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.io.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.kernel.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.layout.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.pdfa.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.sign.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.styledxmlparser.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\itext.svg.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\Microsoft.Extensions.Logging.Abstractions.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\Microsoft.Extensions.Logging.dll
    Add-Type -Path $PSScriptRoot\Lib\Default\Microsoft.Extensions.Options.dll
}
# SIG # Begin signature block
# MIInPgYJKoZIhvcNAQcCoIInLzCCJysCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPrRYiayUUI8uV
# 0wxgSi03Idynu9GSnqJQDZbuujvasaCCITcwggO3MIICn6ADAgECAhAM5+DlF9hG
...
# SIb3DQEJBDEiBCC3E79q6IitNIqIclPI+2oIlwJ0XHZEEniPaOId10wnyjANBgkq
# hkiG9w0BAQEFAASCAQAEkErkFoyiDs6ZMZLVMJhLOrAsb8vKxV2yScu7UJSnwLOW
# qwNc37ID7hsBXr+uk0NgDG8wuNExmy5IGpLXkod/om+YcShPIw2nAf84YjxWncBz
# 2PfsfgLbPSHeDl3gR+1APKCAjS3h62XwZpgp700u0qku+XN5mAoFzIJllx+16F1B
# tpPFblH+gbWdasB9aIDUSMs53vsGmFlOGuaKrTwy/Pji3NYdUdJDAKxOT88suPK6
# EYjQ8/WGHEPwqg1sAwyRmKgggnu3V26LKtQ/adMhndKJmR3Oqe51c9wFrjr+j079
# 4n8ItNg5s9bspqWCnKInMgHsIRdad21CJWoDEkGIoYIDIDCCAxwGCSqGSIb3DQEJ
# BjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0
# LCBJbmMuMTswOQYDVQQDEzJEaWdpQ2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hB
# MjU2IFRpbWVTdGFtcGluZyBDQQIQDE1pckuU+jwqSj0pB4A9WjANBglghkgBZQME
# AgEFAKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTIyMTAwMjE3MjQyN1owLwYJKoZIhvcNAQkEMSIEIL+2IiinuJlUBP1lvdgoI67g
# 4TfpTaIuQMCLUc7LcfdTMA0GCSqGSIb3DQEBAQUABIICAFcv6kW4NRJZy8jVN0tK
# rBYUqA5ORQbTVXn0PS4YRmdKMihZrr7CW2cRnb2p3ue0TNiAqMm4V4xzWgC1YCZM
# dh6eKbqIrtdWxqwYjJDg5zpIf3+w5BDW+77N+AFf16ckkQbXTPYKlpDp6KsDPS/y
# 6OHq05MtkMZwu1nIaT64u8Ca3oFq72exm1TNU9zajANGIL3CUjZO8h62+X8uZ2pB
# zXqvwYw5xaXUf8/9qJWAyrEoqIkanfrrcA/hBFHGppjiIQ6BFtrm9XxxDFPSQPiA
# Nql7hPRiR0HDv0t9MpLwVVe0mOJ2fI4Fb+e7Q0RqT7js3zKPFjNatHoGSEFzFPPx
# 6axFncE8+9f/63QL5kXjWYuFyYyHGfhwfJTKXmV6MI3A23XhXXGYuxYsqPTTzymP
# lQAO3VUYVuYjWf+D9AW+PSVwHpIoRxeIHlgCQ2+dbGg+Zp4iRBXSgZhdQJO4XgRY
# TqQ4xt7WrIJUVuXEPYq4h8IiJdnOX6yO49Z5rMaL8oGe42/AbsmAcQFE3tn2eM9D
# n8OUDLFC0vH7+0w2MFa7xb4e9RF/jPsmgLEeovpjtJbY8zrMJFojzeETTH9CvdCF
# GsE2zD2ad2It+c68cfW5mzFu1as3eXlN6SxToby//1dQ+Oodf1iw40+rCYe1aiOa
# gZf3QQyXa5zJgnkW4LmwfMaU
